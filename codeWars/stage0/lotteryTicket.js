...
function bingo(ticket, win){
    return (ticket.reduce(function(miniWins,subarray){

      return (subarray[0].split('').reduce(function(count,letter) {

          return (letter.codePointAt(0) === subarray[1]) ? count = true : count;
        },false) === true) ? ++miniWins : miniWins;
